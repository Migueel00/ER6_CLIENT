...
import Curse, { Modifiers } from './curse.tsx';
import Ingredient from './ingredient.tsx';
import Potion, { Antidote, Elixir, Essence, FailedPotion, Poison, PurificationPotion, Stench, Venom } from './potion.tsx';
...
export default class Cauldron {
	...
	private createRandomModifiers(effects: string[]) {
		...
		effects.forEach(item => {
			...
			const rarity = prefixes.find(p => item.startsWith(p)) || 'no prefix';
